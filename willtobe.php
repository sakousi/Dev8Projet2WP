...
<?php get_header(); ?>
	<div class="bg-blue w-full">
		<header class="container flex justify-center items-center flex-col !py-48 md:w-2/3">
				<p class="text-lg text-white font-bold text-center"><?= get_field('up_title'); ?></p>
				<h1 class="md:text-5xl text-4xl font-extrabold font-khula text-white text-center py-12"><?php the_field('title'); ?></h1>
		</header>
	</div>
	<section class="container text-blue">
		<p class="font-bold text-lg"><?php the_field('up_title_2'); ?></p>
		<h2 class="font-extrabold md:text-4xl text-3xl md:w-1/2 py-12"><?php the_field('title_2'); ?></h2>
	...
	<div class="bg-blue w-full">
		<section class="container flex flex-col text-white">
			...
			<h2 class="font-extrabold md:text-4xl text-3xl md:w-1/2 py-12"><?php the_field('title_3'); ?></h2>
			<?= get_field('desc_3') ?>
		</section>
	</div>
    <div class="bg-creamy w-full">
	    <section class="container text-blue">
            <div class="flex flex-col items-center">
                ...
                <h2 class="font-extrabold md:text-4xl text-3xl md:w-1/2 py-12 text-center"><?php the_field('title_4'); ?></h2>
	    	    <?php if(have_rows('repeater_4')): ?>
                    <div class="flex justify-center flex-wrap">
	    	    		<?php while(have_rows('repeater_4')): the_row(); ?>
                            <div class="md:basis-1/3 sm:basis-1/2 basis-full pb-8">
                                <h3 class="font-bold text-lg"><?php the_sub_field('title'); ?></h3>
                                <p><?php the_sub_field('desc'); ?></p>
                            </div>
	    	    		<?php endwhile; ?>
            ...
            <div class="flex flex-col items-center">
                <h3 class="font-extrabold md:text-4xl text-3xl md:w-1/2 text-center py-12"><?php the_field('2_title_4'); ?></h3>
                <?php if(have_rows('2_repeater_4')): ?>
                    <div class="flex justify-center flex-wrap pt-12">
                        <?php while(have_rows('2_repeater_4')): the_row(); ?>
                            <div class="flex flex-col items-center md:basis-1/4 sm:basis-1/2 basis-full px-8 text-center">
    ...
    <section class="container text-blue flex flex-col items-center text-center">
        ...
        <h2 class="font-extrabold md:text-4xl text-3xl md:w-1/2 py-12"><?php the_field('title_5'); ?></h2>
            <?php if(have_rows('repeater_5')): ?>
                <div class="grid md:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-8">
