...
<div class="bg-blue w-full">
	<header class="container text-white flex flex-col items-center w-1/2 text-center">
		<p class="text-lg font-bold"><?php the_field('up_title'); ?></p>
		<h1 class="py-8 text-4xl font-extrabold"><?php the_field('title'); ?></h1>
		<p><?php the_field('desc'); ?></p>
	</header>
</div>
	<main>
		<section class="container text-blue">
			<h2 class="py-8 text-4xl font-extrabold"><?php the_field('title_2'); ?></h2>
		...
		<div class="bg-blue w-full">
			<section class="container text-white">
                <div class="w-1/2 pb-10">
				    ...
				    <h2 class="py-8 text-4xl font-extrabold"><?php the_field('title_3'); ?></h2>
